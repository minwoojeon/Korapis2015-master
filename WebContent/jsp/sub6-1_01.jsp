...
<!--         <div id="bo_v_video">
        ...
        <!-- 본문 내용 시작 { -->
        <%if(!"".equals(vo.getBbsLink())){ %>
        <div id="bo_v_con">
        <iframe width="720" height="416" src="//www.youtube-nocookie.com/embed/<%=vo.getBbsLink() %>?showinfo=0" frameborder="0" allowfullscreen style="margin:10px"></iframe>
		</div> 
		<%} %>
    ...
    <div id="bo_v_bot">
        ...
        <ul class="bo_v_com">
        	<li><a href="sub6-1.jsp" class="btn_b01">목록</a></li>
		</ul>
            </div>
    <!-- } 링크 버튼 끝 -->
