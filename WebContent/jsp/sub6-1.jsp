...
String bflag = TextFormatter.convNvl(request.getParameter("bflag"), "02");
        ...
        <div id="sub_contents">
            ...
            <div id="sub_con_box">
                <div class="sub_top_box">
                    <h2 class="page_title">동영상홍보</h2>
                    <div class="location">홈  &gt; 홍보센터 &gt; <span>동영상홍보</span></div>
                </div>
		...
		<li class="bo_img_list_li ">
			...
			<ul class="bo_img_con"> 
                <li class="bo_img_href">
                	<a href="sub6-1_01.jsp?no=<%=d.getString("bbs_idx") %>">
                	<%if(!"".equals(d.getString("file_path"))){ %>
                	...
                	<%}else{ %>
                	<img src="https://i.ytimg.com/vi/<%=d.getString("bbs_link") %>/hqdefault.jpg" width="140" height="100" />
                	<%} %>
                	</a>
                    <%-- <a href="sub6-1_01.jsp?no=<%=d.getString("no") %>"><img src="http://img.youtube.com/vi/<%=d.getString("video_url") %>/0.jpg" alt="" width="150" height="110"></a> --%>
                </li>
            </ul>  
			<ul class="bo_img_con2"> 
				...
				<li><a href="sub6-1_01.jsp?no=<%=d.getString("bbs_idx") %>"><%=d.getString("bbs_title") %></a></li>
      		</ul>
      	</li>
