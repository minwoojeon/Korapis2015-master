...
public class SendExample {	
	public static void main(String[] args) {	
		...
		//set.setTo(new String[] { "01000000001", "01000000002", "01000000003", "01000000004" }); // 받는사람 번호 여러개 입력시
		set.setFrom("0264647222"); // 보내는 사람 번호
		set.setText("양봉협회 테스트."); // 문자내용 SMS(80바이트), LMS(장문 2,000바이트), MMS(장문+이미지)
